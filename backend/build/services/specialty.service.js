...
var createNewSpecialty = function createNewSpecialty(payload) {
      ...
      return _regenerator().w(function (_context) {
        while (1) switch (_context.n) {
          ...
          case 2:
            ...
            return _context.a(2, resolve({
              EC: 2,
              EM: "Cannot create new specialty!"
            }));
          case 3:
            resolve({
              EC: 0,
        ...
        while (1) switch (_context2.n) {
          ...
          case 1:
            ...
            data.map(function (item) {
              return item.image = Buffer.from(item.image, 'base64').toString('binary');
            });
            return _context2.a(2, resolve({
              EC: 0,
              EM: "Get All Specialty Successed",
              data: data
            }));
          case 2:
            return _context2.a(2, resolve({
              EC: 0,
              EM: "Get All Specialty Failed"
            }));
          case 3:
            _context2.n = 5;
            break;
...
var getDetailSpecialty = function getDetailSpecialty(id, location) {
  return new Promise(/*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(resolve, reject) {
      var specialty, doctorInfos, _t3;
